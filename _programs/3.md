...
To support our community, we developed the [bedrock-server-manager](https://github.com/digitaledsafety/bedrock-server-manager), an open-source tool designed to simplify the deployment and management of Minecraft Bedrock Edition servers. This ensures our environments remain safe, stable, and ready for learning.
